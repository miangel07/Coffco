...
INSERT INTO `documentos` (`id_documentos`, `nombre`, `fecha_carga`, `fk_id_usuarios`, `descripcion`, `formato`, `estado`) VALUES
(2, 'procesos misionales', '2024-04-03', 1, 'documento de procesos misionales', 'pdf', 'activo'),
(6, 'procesos logicos', '2024-04-27', 1, 'procesos logicos', 'pdf', 'activo'),
(7, 'procesos estrategicos', '2024-04-27', 1, 'procesos misionales', 'pdf', 'activo'),
(8, 'formato tostion ingresos', '2024-04-29', 1, 'tostion', 'excel', 'activo');
...
--
ALTER TABLE `documentos`
  MODIFY `id_documentos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
